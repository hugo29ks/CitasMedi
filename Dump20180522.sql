...
CREATE TABLE `medico` (
  ...
  `ID_UsuarioM` int(10) unsigned NOT NULL,
  PRIMARY KEY (`ID_Medico`),
  UNIQUE KEY `ID_Medico` (`ID_Medico`),
  KEY `ID_Especialidad` (`ID_Especialidad`),
  KEY `fk_medico_usuario1_idx` (`ID_UsuarioM`),
  CONSTRAINT `medico_ibfk_1` FOREIGN KEY (`ID_Especialidad`) REFERENCES `especialidad` (`ID_Especialidad`),
  CONSTRAINT `fk_medico_usuario1` FOREIGN KEY (`ID_UsuarioM`) REFERENCES `usuario` (`ID_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `paciente` VALUES (1,'ron','san','26198484','M',0,'1723029446','aascorreo'),(2,'sad','fggt','012345678','Masculino',0,'155','sdddf'),(3,'sss','ssffr','1233','ass',1,'135','dffr'),(4,'Ronny','Cabrera','1234-5679','Femenino',1,'9874563210','asa@hotmail.com');
...
CREATE TABLE `recepcionista` (
  `ID_Recepcionitas` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `Nombre_Recep` varchar(50) CHARACTER SET utf8 NOT NULL,
  `Cedula_Recep` varchar(100) CHARACTER SET utf8 NOT NULL,
  `Estado` tinyint(1) NOT NULL DEFAULT '1',
  `ID_UsuarioR` int(10) unsigned NOT NULL,
  PRIMARY KEY (`ID_Recepcionitas`),
  UNIQUE KEY `ID_Usuario` (`ID_Recepcionitas`),
  KEY `fk_recepcionista_usuario1_idx` (`ID_UsuarioR`),
  CONSTRAINT `fk_recepcionista_usuario1` FOREIGN KEY (`ID_UsuarioR`) REFERENCES `usuario` (`ID_Usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `usuario` VALUES (1,'Admin','1234','Admin',1),(2,'secre1','1234','Secretaria',1);
...
-- Dump completed on 2018-05-22 15:07:17
